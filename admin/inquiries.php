...
if ($q !== '') {
    $like = '%' . $q . '%';
    $where[] = '(name LIKE ? OR email LIKE ? OR phone LIKE ? OR whatsapp LIKE ? OR company LIKE ? OR country LIKE ? OR support_type LIKE ? OR product LIKE ? OR product_link LIKE ? OR page_type LIKE ? OR page_title LIKE ? OR message LIKE ? OR source LIKE ?)';
