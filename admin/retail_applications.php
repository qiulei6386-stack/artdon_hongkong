...
$known = ra_retail_application_pages();
if (!isset($known[$slug])) $slug = 'fashion-store';
...
<section class="ra-admin">
  <header class="ra-admin-head">
    <div>
      ...
      <span>统一管理零售应用详情页模板内容，前台 6 个页面共用同一版型。</span>
    </div>
