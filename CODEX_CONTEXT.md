...
- SEO work follows the user-approved sequence: complete one item, validate front and back end, report, then wait for confirmation before starting the next. Sitemap/robots, URL/301/www-SSL, SEO Title/Description, NO IMAGE / duplicate product / empty-content cleanup, unified contact information, structured data, Google Search Console submission/verification and keyword allocation/internal linking are complete. Next item is mobile speed and Core Web Vitals; do not begin it until the user confirms.
