...
- The latest completed item is website image standards: new uploads are auto-WebP/resized/compressed by usage, backend media upload shows the standard table, and the formal standard is documented in `docs/IMAGE_STANDARDS.md`.
- No open code changes are pending after committing the website image standards cleanup.
