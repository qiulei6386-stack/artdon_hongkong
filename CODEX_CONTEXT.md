...
- The latest completed item is security headers baseline: CSP, X-Frame, Referrer Policy, Permissions Policy, mixed-content controls and related headers are live on normal and cached PHP responses; manual SecurityHeaders.com browser verification remains recommended because automated fetch hit Cloudflare challenge.
- No open code changes are pending after committing the security headers baseline changes.
