...
<main class="series-v717">
  ...
  <section class="s717-shell s717-support">
    <div><p class="s717-kicker"><?= sv717_e($content['support_kicker']) ?></p><h2><?= sv717_e($content['support_title']) ?></h2><p><?= sv717_e($content['support_text']) ?></p></div><div class="s717-support-actions"><?php $btns=[[$content['support_button1_label'],$content['support_button1_url'],'quote'],[$content['support_button2_label'],$content['support_button2_url'],'quote'],[$content['support_button3_label'],$content['support_button3_url'],'download']]; foreach($btns as $b): if(trim((string)$b[0])!==''): ?><a href="<?= sv717_e(sv717_button_url((string)$b[1],$series,$b[2])) ?>"><?= sv717_e($b[0]) ?> →</a><?php endif; endforeach; ?></div>
  </section>
